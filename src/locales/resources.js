...
import { applyLocaleDeepVoiceRefinements } from './deepVoiceRefinements.js';
...
const zhTW = {
  ...
  header: {
    ...
    csvProfiles: {
      ...
      brokerAr: '阿文券商 CSV',
      brokerEuro: '歐系券商 CSV',
      trading212Transactions: 'Trading 212 交易紀錄 CSV',
      freetradeTransactions: 'Freetrade 交易活動 CSV',
      scalableTransactions: 'Scalable Capital 交易紀錄 CSV',
      saxoTransactions: 'Saxo 交易紀錄 CSV',
  ...
  manager: {
    ...
    symbolOverrides: {
      ...
      typeDelist: '下市（強制清倉）',
      sourceCode: '來源代號',
      sourceMarket: '來源市場（選填）',
      anyMarket: '任何市場',
      targetCode: '目標代號',
      targetMarket: '目標市場（選填）',
      sameAsSource: '與來源相同',
      delistDate: '下市日期',
      delistPrice: '最後成交價',
      note: '備註（選填）',
      add: '新增',
      emptyHint: '目前無規則。點擊「新增規則」來設定代號別名或下市清倉。',
      noCustomRules: '目前無自訂規則。點擊「新增規則」來新增一條。',
      builtIn: '內建',
      deleteRule: '刪除此規則',
      delistAutoNote: '下市規則在計算損益時會自動注入「全數賣出」紀錄。原始資料不受影響。',
      delistLabel: '下市清倉',
      autoLabel: '自動'
    }
  },
...
const yueHantHK = {
  ...
  manager: {
    ...
    symbolOverrides: {
      ...
      note: '備註（選填）',
      add: '加入',
      emptyHint: '而家冇規則。撳「新增規則」設定代號別名或下市清倉。',
      noCustomRules: '冇自訂規則。撳「新增規則」加一條。',
      builtIn: '內建',
      deleteRule: '刪除呢條規則',
      delistAutoNote: '下市規則喺計算損益時會自動插入「全部賣出」紀錄。原始資料唔會受影響。',
      delistLabel: '下市清倉',
      autoLabel: '自動'
    }
  },
...
const zhCN = {
  ...
  header: {
    ...
    csvProfiles: {
      ...
      brokerAr: '阿拉伯文券商 CSV',
      brokerEuro: '欧系券商 CSV',
      trading212Transactions: 'Trading 212 交易记录 CSV',
      freetradeTransactions: 'Freetrade 交易活动 CSV',
      scalableTransactions: 'Scalable Capital 交易记录 CSV',
      saxoTransactions: 'Saxo 交易记录 CSV',
  ...
  manager: {
    ...
    symbolOverrides: {
      ...
      note: '备注（可选）',
      add: '新增',
      emptyHint: '暂无规则。点击「新增规则」设置代号别名或退市清仓。',
      noCustomRules: '暂无自定义规则。点击「新增规则」新增一条。',
      builtIn: '内置',
      deleteRule: '删除此规则',
      delistAutoNote: '退市规则在计算盈亏时会自动注入「全部卖出」记录，不会修改原始数据。',
      delistLabel: '退市清仓',
      autoLabel: '自动'
    }
  },
...
const zhSG = {
  ...
  manager: {
    ...
    symbolOverrides: {
      ...
      typeDelist: '退市（强制清仓）',
      sourceCode: '来源代号',
      sourceMarket: '来源市场（选填）',
      anyMarket: '任意市场',
      targetCode: '目标代号',
      targetMarket: '目标市场（选填）',
      sameAsSource: '与来源相同',
      delistDate: '退市日期',
      delistPrice: '最后成交价',
      note: '备注（选填）',
      add: '新增',
      emptyHint: '暂无规则。点击「新增规则」来设置代号别名或退市清仓。',
      noCustomRules: '暂无自定义规则。点击「新增规则」新增一条。',
      builtIn: '内置',
      deleteRule: '删除此规则',
      delistAutoNote: '退市规则在计算盈亏时会自动注入「全部卖出」记录，不会修改原始资料。',
      delistLabel: '退市清仓',
      autoLabel: '自动'
    }
  },
...
const enUS = {
  ...
  header: {
    ...
    csvProfiles: {
      ...
      trading212Transactions: 'Trading 212 transactions CSV',
      freetradeTransactions: 'Freetrade activity CSV',
      scalableTransactions: 'Scalable Capital transactions CSV',
      saxoTransactions: 'Saxo transactions CSV',
  ...
  manager: {
    ...
    symbolOverrides: {
      title: 'Symbol Override Rules',
      addRule: 'Add Rule',
      ruleType: 'Rule Type',
      typeAlias: 'Alias (rename)',
      typeDelist: 'Delist (force close)',
      sourceCode: 'Source Symbol',
      sourceMarket: 'Source Market (optional)',
      anyMarket: 'Any market',
      targetCode: 'Target Symbol',
      targetMarket: 'Target Market (optional)',
      sameAsSource: 'Same as source',
      delistDate: 'Delist Date',
      delistPrice: 'Last Trade Price',
      note: 'Note (optional)',
      add: 'Add',
      emptyHint: 'No rules yet. Click "Add Rule" to set up ticker aliases or delist close-outs.',
      noCustomRules: 'No custom rules yet. Click "Add Rule" to add one.',
      builtIn: 'built-in',
      deleteRule: 'Delete this rule',
      delistAutoNote: 'Delist rules auto-inject a "sell all" record when computing P&L. Your original data is not modified.',
      delistLabel: 'delist close',
      autoLabel: 'auto'
    }
  },
  notice: {
...
const jaJP = {
  ...
  header: {
    ...
    csvProfiles: {
      ...
      trading212Transactions: 'Trading 212 取引履歴 CSV',
      freetradeTransactions: 'Freetrade 取引アクティビティ CSV',
      scalableTransactions: 'Scalable Capital 取引履歴 CSV',
      saxoTransactions: 'Saxo 取引履歴 CSV',
  ...
  manager: {
    ...
    symbolOverrides: {
      ...
      addRule: 'ルールを追加',
      ruleType: 'ルールの種類',
      typeAlias: 'エイリアス（名称変更）',
      typeDelist: '上場廃止（強制決済）',
      sourceCode: '元の銘柄コード',
      sourceMarket: '元の市場（任意）',
      anyMarket: 'すべての市場',
      targetCode: '変換先銘柄コード',
      targetMarket: '変換先の市場（任意）',
      sameAsSource: '元の市場と同じ',
      delistDate: '上場廃止日',
      delistPrice: '最終取引価格',
      note: 'メモ（任意）',
      add: '追加',
      emptyHint: 'ルールなし。「ルールを追加」から銘柄エイリアスや上場廃止の決済を設定できます。',
      noCustomRules: 'カスタムルールなし。「ルールを追加」から追加してください。',
      builtIn: '組み込み',
      deleteRule: 'このルールを削除',
      delistAutoNote: '上場廃止ルールは損益計算時に「全株売却」レコードを自動挿入します。元データは変更されません。',
      delistLabel: '上場廃止清算',
      autoLabel: '自動'
    }
  },
...
const koKR = {
  ...
  manager: {
    ...
    symbolOverrides: {
      ...
      ruleType: '규칙 유형',
      typeAlias: '별칭 (이름 변경)',
      typeDelist: '상장폐지 (강제 청산)',
      sourceCode: '원본 종목코드',
      sourceMarket: '원본 시장 (선택)',
      anyMarket: '모든 시장',
      targetCode: '대상 종목코드',
      ...
      note: '메모 (선택)',
      add: '추가',
      emptyHint: '규칙이 없습니다. 「규칙 추가」를 클릭해 종목 별칭이나 상장폐지 청산을 설정하세요.',
      noCustomRules: '사용자 정의 규칙이 없습니다. 「규칙 추가」를 클릭해 추가하세요.',
      builtIn: '기본 제공',
      deleteRule: '이 규칙 삭제',
      delistAutoNote: '상장폐지 규칙은 손익 계산 시 「전량 매도」 내역을 자동으로 삽입합니다. 원본 데이터는 변경되지 않습니다.',
      delistLabel: '상장폐지 청산',
      autoLabel: '자동'
    }
  },
...
const idID = {
  ...
  manager: {
    ...
    symbolOverrides: {
      title: 'Aturan Penggantian Simbol',
      addRule: 'Tambah Aturan',
      ruleType: 'Jenis Aturan',
      typeAlias: 'Alias (ganti nama)',
      typeDelist: 'Delisting (tutup paksa)',
      sourceCode: 'Simbol Sumber',
      sourceMarket: 'Pasar Sumber (opsional)',
      anyMarket: 'Semua pasar',
      targetCode: 'Simbol Target',
      targetMarket: 'Pasar Target (opsional)',
      sameAsSource: 'Sama dengan sumber',
      delistDate: 'Tanggal Delisting',
      delistPrice: 'Harga Transaksi Terakhir',
      note: 'Catatan (opsional)',
      add: 'Tambah',
      emptyHint: 'Belum ada aturan. Klik "Tambah Aturan" untuk mengatur alias simbol atau penutupan delisting.',
      noCustomRules: 'Belum ada aturan kustom. Klik "Tambah Aturan" untuk menambahkan.',
      builtIn: 'bawaan',
      deleteRule: 'Hapus aturan ini',
      delistAutoNote: 'Aturan delisting secara otomatis menyisipkan catatan "jual semua" saat menghitung P&L. Data asli tidak diubah.',
      delistLabel: 'penutupan delisting',
      autoLabel: 'otomatis'
    }
  },
  notice: {
...
const frFR = {
  ...
  manager: {
    ...
    symbolOverrides: {
      title: 'Règles de remplacement de symboles',
      addRule: 'Ajouter une règle',
      ruleType: 'Type de règle',
      typeAlias: 'Alias (renommer)',
      typeDelist: 'Radiation (clôture forcée)',
      sourceCode: 'Symbole source',
      sourceMarket: 'Marché source (optionnel)',
      anyMarket: 'Tous les marchés',
      targetCode: 'Symbole cible',
      targetMarket: 'Marché cible (optionnel)',
      sameAsSource: 'Même que la source',
      delistDate: 'Date de radiation',
      delistPrice: 'Dernier cours',
      note: 'Note (optionnelle)',
      add: 'Ajouter',
      emptyHint: 'Aucune règle. Cliquez sur « Ajouter une règle » pour configurer des alias ou des clôtures de radiation.',
      noCustomRules: 'Aucune règle personnalisée. Cliquez sur « Ajouter une règle » pour en créer une.',
      builtIn: 'intégré',
      deleteRule: 'Supprimer cette règle',
      delistAutoNote: 'Les règles de radiation injectent automatiquement un enregistrement « tout vendre » lors du calcul des P&L. Vos données d\'origine ne sont pas modifiées.',
      delistLabel: 'clôture radiation',
      autoLabel: 'auto'
    }
  },
  notice: {
...
const deDE = {
  ...
  manager: {
    ...
    symbolOverrides: {
      title: 'Symbol-Ersetzungsregeln',
      addRule: 'Regel hinzufügen',
      ruleType: 'Regeltyp',
      typeAlias: 'Alias (umbenennen)',
      typeDelist: 'Delisting (Zwangsschluss)',
      sourceCode: 'Quell-Symbol',
      sourceMarket: 'Quellmarkt (optional)',
      anyMarket: 'Alle Märkte',
      targetCode: 'Ziel-Symbol',
      targetMarket: 'Zielmarkt (optional)',
      sameAsSource: 'Gleich wie Quelle',
      delistDate: 'Delisting-Datum',
      delistPrice: 'Letzter Handelskurs',
      note: 'Notiz (optional)',
      add: 'Hinzufügen',
      emptyHint: 'Keine Regeln. Klicke auf „Regel hinzufügen", um Ticker-Aliase oder Delisting-Abwicklungen einzurichten.',
      noCustomRules: 'Keine benutzerdefinierten Regeln. Klicke auf „Regel hinzufügen", um eine hinzuzufügen.',
      builtIn: 'integriert',
      deleteRule: 'Diese Regel löschen',
      delistAutoNote: 'Delisting-Regeln fügen beim Berechnen von Gewinnen/Verlusten automatisch einen „alles verkaufen"-Eintrag ein. Die Originaldaten werden nicht verändert.',
      delistLabel: 'Delisting-Abschluss',
      autoLabel: 'auto'
    }
  },
  notice: {
...
const es419 = {
  ...
  manager: {
    ...
    symbolOverrides: {
      title: 'Reglas de sustitución de símbolos',
      addRule: 'Añadir regla',
      ruleType: 'Tipo de regla',
      typeAlias: 'Alias (cambio de nombre)',
      typeDelist: 'Exclusión (cierre forzado)',
      sourceCode: 'Símbolo de origen',
      sourceMarket: 'Mercado de origen (opcional)',
      anyMarket: 'Cualquier mercado',
      targetCode: 'Símbolo de destino',
      targetMarket: 'Mercado de destino (opcional)',
      sameAsSource: 'Igual que el origen',
      delistDate: 'Fecha de exclusión',
      delistPrice: 'Último precio de negociación',
      note: 'Nota (opcional)',
      add: 'Añadir',
      emptyHint: 'Sin reglas. Haz clic en «Añadir regla» para configurar alias de ticker o cierres por exclusión.',
      noCustomRules: 'Sin reglas personalizadas. Haz clic en «Añadir regla» para agregar una.',
      builtIn: 'incorporado',
      deleteRule: 'Eliminar esta regla',
      delistAutoNote: 'Las reglas de exclusión inyectan automáticamente un registro «vender todo» al calcular P&L. Los datos originales no se modifican.',
      delistLabel: 'cierre por exclusión',
      autoLabel: 'auto'
    }
  },
  notice: {
...
const itIT = {
  ...
  manager: {
    ...
    symbolOverrides: {
      title: 'Regole di sostituzione simboli',
      addRule: 'Aggiungi regola',
      ruleType: 'Tipo di regola',
      typeAlias: 'Alias (rinomina)',
      typeDelist: 'Delisting (chiusura forzata)',
      sourceCode: 'Simbolo sorgente',
      sourceMarket: 'Mercato sorgente (opzionale)',
      anyMarket: 'Tutti i mercati',
      targetCode: 'Simbolo destinazione',
      targetMarket: 'Mercato destinazione (opzionale)',
      sameAsSource: 'Uguale alla sorgente',
      delistDate: 'Data di delisting',
      delistPrice: 'Ultimo prezzo di trading',
      note: 'Nota (opzionale)',
      add: 'Aggiungi',
      emptyHint: 'Nessuna regola. Clicca su «Aggiungi regola» per configurare alias o chiusure da delisting.',
      noCustomRules: 'Nessuna regola personalizzata. Clicca su «Aggiungi regola» per aggiungerne una.',
      builtIn: 'integrato',
      deleteRule: 'Elimina questa regola',
      delistAutoNote: 'Le regole di delisting inseriscono automaticamente un record «vendi tutto» nel calcolo del P&L. I dati originali non vengono modificati.',
      delistLabel: 'chiusura delisting',
      autoLabel: 'auto'
    }
  },
  notice: {
...
const nlNL = {
  ...
  manager: {
    ...
    symbolOverrides: {
      title: 'Symbool-vervangingsregels',
      addRule: 'Regel toevoegen',
      ruleType: 'Regeltype',
      typeAlias: 'Alias (hernoemen)',
      typeDelist: 'Delisting (gedwongen sluiting)',
      sourceCode: 'Bronsymbool',
      sourceMarket: 'Bronmarkt (optioneel)',
      anyMarket: 'Alle markten',
      targetCode: 'Doelsymbool',
      targetMarket: 'Doelmarkt (optioneel)',
      sameAsSource: 'Zelfde als bron',
      delistDate: 'Delistingdatum',
      delistPrice: 'Laatste handelsprijs',
      note: 'Opmerking (optioneel)',
      add: 'Toevoegen',
      emptyHint: 'Geen regels. Klik op \"Regel toevoegen\" om ticker-aliassen of delisting-sluitingen in te stellen.',
      noCustomRules: 'Geen aangepaste regels. Klik op \"Regel toevoegen\" om er een toe te voegen.',
      builtIn: 'ingebouwd',
      deleteRule: 'Deze regel verwijderen',
      delistAutoNote: 'Delistingregels voegen automatisch een \"alles verkopen\"-record in bij het berekenen van winst/verlies. Uw originele gegevens worden niet gewijzigd.',
      delistLabel: 'delisting-sluiting',
      autoLabel: 'auto'
    }
  },
  notice: {
...
const ptBR = {
  ...
  manager: {
    ...
    symbolOverrides: {
      title: 'Regras de substituição de símbolos',
      addRule: 'Adicionar regra',
      ruleType: 'Tipo de regra',
      typeAlias: 'Apelido (renomear)',
      typeDelist: 'Deslistagem (fechamento forçado)',
      sourceCode: 'Símbolo de origem',
      sourceMarket: 'Mercado de origem (opcional)',
      anyMarket: 'Qualquer mercado',
      targetCode: 'Símbolo de destino',
      targetMarket: 'Mercado de destino (opcional)',
      sameAsSource: 'Igual à origem',
      delistDate: 'Data de deslistagem',
      delistPrice: 'Último preço negociado',
      note: 'Observação (opcional)',
      add: 'Adicionar',
      emptyHint: 'Sem regras. Clique em «Adicionar regra» para configurar apelidos de ticker ou fechamentos por deslistagem.',
      noCustomRules: 'Sem regras personalizadas. Clique em «Adicionar regra» para adicionar uma.',
      builtIn: 'nativo',
      deleteRule: 'Excluir esta regra',
      delistAutoNote: 'Regras de deslistagem injetam automaticamente um registro «vender tudo» ao calcular P&L. Seus dados originais não são modificados.',
      delistLabel: 'fechamento por deslistagem',
      autoLabel: 'auto'
    }
  },
  notice: {
...
const msMY = {
  ...
  manager: {
    ...
    symbolOverrides: {
      title: 'Peraturan Penggantian Simbol',
      addRule: 'Tambah Peraturan',
      ruleType: 'Jenis Peraturan',
      typeAlias: 'Alias (namakan semula)',
      typeDelist: 'Penyenaraian semula (tutup paksa)',
      sourceCode: 'Simbol Sumber',
      sourceMarket: 'Pasaran Sumber (pilihan)',
      anyMarket: 'Semua pasaran',
      targetCode: 'Simbol Sasaran',
      targetMarket: 'Pasaran Sasaran (pilihan)',
      sameAsSource: 'Sama dengan sumber',
      delistDate: 'Tarikh Penyenaraian Semula',
      delistPrice: 'Harga Dagangan Terakhir',
      note: 'Nota (pilihan)',
      add: 'Tambah',
      emptyHint: 'Tiada peraturan. Klik "Tambah Peraturan" untuk menyediakan alias ticker atau penutupan penyenaraian semula.',
      noCustomRules: 'Tiada peraturan tersuai. Klik "Tambah Peraturan" untuk menambah.',
      builtIn: 'terbina dalam',
      deleteRule: 'Padam peraturan ini',
      delistAutoNote: 'Peraturan penyenaraian semula menyisipkan rekod «jual semua» secara automatik semasa mengira P&L. Data asal anda tidak diubah.',
      delistLabel: 'penutupan penyenaraian semula',
      autoLabel: 'auto'
    }
  },
  notice: {
...
const viVN = {
  ...
  manager: {
    ...
    symbolOverrides: {
      title: 'Quy tắc thay thế mã chứng khoán',
      addRule: 'Thêm quy tắc',
      ruleType: 'Loại quy tắc',
      typeAlias: 'Bí danh (đổi tên)',
      typeDelist: 'Hủy niêm yết (đóng bắt buộc)',
      sourceCode: 'Mã nguồn',
      sourceMarket: 'Thị trường nguồn (tùy chọn)',
      anyMarket: 'Mọi thị trường',
      targetCode: 'Mã đích',
      targetMarket: 'Thị trường đích (tùy chọn)',
      sameAsSource: 'Giống nguồn',
      delistDate: 'Ngày hủy niêm yết',
      delistPrice: 'Giá giao dịch cuối',
      note: 'Ghi chú (tùy chọn)',
      add: 'Thêm',
      emptyHint: 'Chưa có quy tắc. Nhấn «Thêm quy tắc» để thiết lập bí danh mã hoặc đóng vị thế khi hủy niêm yết.',
      noCustomRules: 'Chưa có quy tắc tùy chỉnh. Nhấn «Thêm quy tắc» để thêm.',
      builtIn: 'tích hợp sẵn',
      deleteRule: 'Xóa quy tắc này',
      delistAutoNote: 'Quy tắc hủy niêm yết tự động chèn bản ghi «bán tất cả» khi tính P&L. Dữ liệu gốc của bạn không bị thay đổi.',
      delistLabel: 'đóng hủy niêm yết',
      autoLabel: 'tự động'
    }
  },
  notice: {
...
const thTH = {
  ...
  manager: {
    ...
    symbolOverrides: {
      title: 'กฎการแทนที่สัญลักษณ์',
      addRule: 'เพิ่มกฎ',
      ruleType: 'ประเภทกฎ',
      typeAlias: 'นามแฝง (เปลี่ยนชื่อ)',
      typeDelist: 'ถอดออกจากตลาด (ปิดบังคับ)',
      sourceCode: 'สัญลักษณ์ต้นทาง',
      sourceMarket: 'ตลาดต้นทาง (ไม่บังคับ)',
      anyMarket: 'ทุกตลาด',
      targetCode: 'สัญลักษณ์เป้าหมาย',
      targetMarket: 'ตลาดเป้าหมาย (ไม่บังคับ)',
      sameAsSource: 'เหมือนต้นทาง',
      delistDate: 'วันที่ถอดออกจากตลาด',
      delistPrice: 'ราคาซื้อขายสุดท้าย',
      note: 'หมายเหตุ (ไม่บังคับ)',
      add: 'เพิ่ม',
      emptyHint: 'ยังไม่มีกฎ คลิก "เพิ่มกฎ" เพื่อตั้งค่านามแฝงหรือการปิดบังคับเมื่อถอดออกจากตลาด',
      noCustomRules: 'ยังไม่มีกฎที่กำหนดเอง คลิก "เพิ่มกฎ" เพื่อเพิ่ม',
      builtIn: 'ในตัว',
      deleteRule: 'ลบกฎนี้',
      delistAutoNote: 'กฎถอดออกจากตลาดจะแทรกรายการ "ขายทั้งหมด" โดยอัตโนมัติเมื่อคำนวณ P&L ข้อมูลต้นฉบับของคุณไม่ถูกแก้ไข',
      delistLabel: 'ปิดถอดออกจากตลาด',
      autoLabel: 'อัตโนมัติ'
    }
  },
  notice: {
...
const arSA = {
  ...
  manager: {
    ...
    symbolOverrides: {
      title: 'قواعد استبدال الرموز',
      addRule: 'إضافة قاعدة',
      ruleType: 'نوع القاعدة',
      typeAlias: 'اسم مستعار (إعادة تسمية)',
      typeDelist: 'شطب (إغلاق إجباري)',
      sourceCode: 'رمز المصدر',
      sourceMarket: 'سوق المصدر (اختياري)',
      anyMarket: 'أي سوق',
      targetCode: 'رمز الهدف',
      targetMarket: 'سوق الهدف (اختياري)',
      sameAsSource: 'نفس المصدر',
      delistDate: 'تاريخ الشطب',
      delistPrice: 'آخر سعر تداول',
      note: 'ملاحظة (اختياري)',
      add: 'إضافة',
      emptyHint: 'لا توجد قواعد. انقر على «إضافة قاعدة» لإعداد أسماء مستعارة للرموز أو إغلاقات الشطب.',
      noCustomRules: 'لا توجد قواعد مخصصة. انقر على «إضافة قاعدة» لإضافة واحدة.',
      builtIn: 'مضمّن',
      deleteRule: 'حذف هذه القاعدة',
      delistAutoNote: 'تقوم قواعد الشطب بإدراج سجل «بيع الكل» تلقائيًا عند حساب الأرباح والخسائر. لا يتم تعديل بياناتك الأصلية.',
      delistLabel: 'إغلاق الشطب',
      autoLabel: 'تلقائي'
    }
  },
  notice: {
...
const plPL = {
  ...
  manager: {
    ...
    symbolOverrides: {
      title: 'Reguły zastępowania symboli',
      addRule: 'Dodaj regułę',
      ruleType: 'Typ reguły',
      typeAlias: 'Alias (zmiana nazwy)',
      typeDelist: 'Wycofanie z giełdy (wymuszone zamknięcie)',
      sourceCode: 'Symbol źródłowy',
      sourceMarket: 'Rynek źródłowy (opcjonalnie)',
      anyMarket: 'Dowolny rynek',
      targetCode: 'Symbol docelowy',
      targetMarket: 'Rynek docelowy (opcjonalnie)',
      sameAsSource: 'Taki sam jak źródło',
      delistDate: 'Data wycofania z giełdy',
      delistPrice: 'Ostatnia cena transakcji',
      note: 'Uwaga (opcjonalnie)',
      add: 'Dodaj',
      emptyHint: 'Brak reguł. Kliknij „Dodaj regułę", aby skonfigurować aliasy tickerów lub zamknięcia przy wycofaniu z giełdy.',
      noCustomRules: 'Brak reguł użytkownika. Kliknij „Dodaj regułę", aby dodać jedną.',
      builtIn: 'wbudowany',
      deleteRule: 'Usuń tę regułę',
      delistAutoNote: 'Reguły wycofania z giełdy automatycznie wstawiają rekord „sprzedaj wszystko" podczas obliczania zysków/strat. Oryginalne dane nie są modyfikowane.',
      delistLabel: 'zamknięcie wycofania',
      autoLabel: 'auto'
    }
  },
  notice: {
...
const trTR = {
  ...
  manager: {
    ...
    symbolOverrides: {
      title: 'Sembol Geçersiz Kılma Kuralları',
      addRule: 'Kural Ekle',
      ruleType: 'Kural Türü',
      typeAlias: 'Takma ad (yeniden adlandır)',
      typeDelist: 'Borsadan çıkarma (zorla kapat)',
      sourceCode: 'Kaynak Sembol',
      sourceMarket: 'Kaynak Piyasa (isteğe bağlı)',
      anyMarket: 'Herhangi bir piyasa',
      targetCode: 'Hedef Sembol',
      targetMarket: 'Hedef Piyasa (isteğe bağlı)',
      sameAsSource: 'Kaynakla aynı',
      delistDate: 'Borsadan Çıkarma Tarihi',
      delistPrice: 'Son İşlem Fiyatı',
      note: 'Not (isteğe bağlı)',
      add: 'Ekle',
      emptyHint: 'Kural yok. Ticker takma adları veya borsadan çıkarma kapanışları ayarlamak için «Kural Ekle»ye tıklayın.',
      noCustomRules: 'Özel kural yok. «Kural Ekle»ye tıklayarak bir tane ekleyin.',
      builtIn: 'yerleşik',
      deleteRule: 'Bu kuralı sil',
      delistAutoNote: 'Borsadan çıkarma kuralları, K/Z hesaplanırken otomatik olarak «tümünü sat» kaydı ekler. Orijinal verileriniz değiştirilmez.',
      delistLabel: 'borsadan çıkarma kapanışı',
      autoLabel: 'otomatik'
    }
  },
  notice: {
...
const hiIN = {
  ...
  manager: {
    ...
    symbolOverrides: {
      title: 'प्रतीक ओवरराइड नियम',
      addRule: 'नियम जोड़ें',
      ruleType: 'नियम का प्रकार',
      typeAlias: 'उपनाम (नाम बदलें)',
      typeDelist: 'डीलिस्टिंग (जबरन बंद करें)',
      sourceCode: 'स्रोत प्रतीक',
      sourceMarket: 'स्रोत बाज़ार (वैकल्पिक)',
      anyMarket: 'कोई भी बाज़ार',
      targetCode: 'लक्ष्य प्रतीक',
      targetMarket: 'लक्ष्य बाज़ार (वैकल्पिक)',
      sameAsSource: 'स्रोत के समान',
      delistDate: 'डीलिस्टिंग तिथि',
      delistPrice: 'अंतिम ट्रेड मूल्य',
      note: 'नोट (वैकल्पिक)',
      add: 'जोड़ें',
      emptyHint: 'कोई नियम नहीं। टिकर उपनाम या डीलिस्टिंग बंद करने के लिए «नियम जोड़ें» पर क्लिक करें।',
      noCustomRules: 'कोई कस्टम नियम नहीं। «नियम जोड़ें» पर क्लिक करके एक जोड़ें।',
      builtIn: 'अंतर्निहित',
      deleteRule: 'यह नियम हटाएं',
      delistAutoNote: 'डीलिस्टिंग नियम P&L गणना करते समय स्वचालित रूप से «सब बेचें» रिकॉर्ड जोड़ते हैं। आपका मूल डेटा संशोधित नहीं होता।',
      delistLabel: 'डीलिस्टिंग बंद',
      autoLabel: 'स्वचालित'
    }
  },
  notice: {
...
const ruRU = {
  ...
  manager: {
    ...
    symbolOverrides: {
      title: 'Правила замены символов',
      addRule: 'Добавить правило',
      ruleType: 'Тип правила',
      typeAlias: 'Псевдоним (переименование)',
      typeDelist: 'Делистинг (принудительное закрытие)',
      sourceCode: 'Исходный символ',
      sourceMarket: 'Исходный рынок (необязательно)',
      anyMarket: 'Любой рынок',
      targetCode: 'Целевой символ',
      targetMarket: 'Целевой рынок (необязательно)',
      sameAsSource: 'Как исходный',
      delistDate: 'Дата делистинга',
      delistPrice: 'Последняя цена сделки',
      note: 'Примечание (необязательно)',
      add: 'Добавить',
      emptyHint: 'Правил нет. Нажмите «Добавить правило», чтобы настроить псевдонимы тикеров или закрытия при делистинге.',
      noCustomRules: 'Нет пользовательских правил. Нажмите «Добавить правило», чтобы добавить.',
      builtIn: 'встроенный',
      deleteRule: 'Удалить это правило',
      delistAutoNote: 'Правила делистинга автоматически добавляют запись «продать всё» при расчёте прибыли/убытков. Исходные данные не изменяются.',
      delistLabel: 'закрытие при делистинге',
      autoLabel: 'авто'
    }
  },
  notice: {
...
const faIR = {
  ...
  manager: {
    ...
    symbolOverrides: {
      title: 'قوانین جایگزینی نماد',
      addRule: 'افزودن قانون',
      ruleType: 'نوع قانون',
      typeAlias: 'نام مستعار (تغییر نام)',
      typeDelist: 'حذف از بورس (بستن اجباری)',
      sourceCode: 'نماد منبع',
      sourceMarket: 'بازار منبع (اختیاری)',
      anyMarket: 'هر بازار',
      targetCode: 'نماد هدف',
      targetMarket: 'بازار هدف (اختیاری)',
      sameAsSource: 'مشابه منبع',
      delistDate: 'تاریخ حذف از بورس',
      delistPrice: 'آخرین قیمت معامله',
      note: 'یادداشت (اختیاری)',
      add: 'افزودن',
      emptyHint: 'هیچ قانونی وجود ندارد. برای تنظیم نام‌های مستعار یا بستن پس از حذف از بورس روی «افزودن قانون» کلیک کنید.',
      noCustomRules: 'هیچ قانون سفارشی وجود ندارد. برای افزودن روی «افزودن قانون» کلیک کنید.',
      builtIn: 'داخلی',
      deleteRule: 'حذف این قانون',
      delistAutoNote: 'قوانین حذف از بورس هنگام محاسبه سود/زیان به طور خودکار یک رکورد «همه را بفروش» وارد می‌کنند. داده‌های اصلی شما تغییر نمی‌کند.',
      delistLabel: 'بستن پس از حذف',
      autoLabel: 'خودکار'
    }
  },
  notice: {
...
const heIL = {
  ...
  manager: {
    ...
    symbolOverrides: {
      title: 'כללי החלפת סמלים',
      addRule: 'הוסף כלל',
      ruleType: 'סוג הכלל',
      typeAlias: 'כינוי (שינוי שם)',
      typeDelist: 'מחיקה מהבורסה (סגירה כפויה)',
      sourceCode: 'סמל מקור',
      sourceMarket: 'שוק מקור (אופציונלי)',
      anyMarket: 'כל שוק',
      targetCode: 'סמל יעד',
      targetMarket: 'שוק יעד (אופציונלי)',
      sameAsSource: 'זהה למקור',
      delistDate: 'תאריך מחיקה מהבורסה',
      delistPrice: 'מחיר עסקה אחרון',
      note: 'הערה (אופציונלי)',
      add: 'הוסף',
      emptyHint: 'אין כללים. לחץ על «הוסף כלל» להגדרת כינויים או סגירות בעת מחיקה מהבורסה.',
      noCustomRules: 'אין כללים מותאמים אישית. לחץ על «הוסף כלל» להוספה.',
      builtIn: 'מובנה',
      deleteRule: 'מחק כלל זה',
      delistAutoNote: 'כללי מחיקה מהבורסה מזריקים אוטומטית רשומת «מכור הכל» בחישוב רווח/הפסד. הנתונים המקוריים שלך אינם משתנים.',
      delistLabel: 'סגירת מחיקה',
      autoLabel: 'אוטומטי'
    }
  },
  notice: {
...
const svSE = {
  ...
  manager: {
    ...
    symbolOverrides: {
      title: 'Regler för symbolersättning',
      addRule: 'Lägg till regel',
      ruleType: 'Regeltyp',
      typeAlias: 'Alias (byt namn)',
      typeDelist: 'Avnotering (tvångsstängning)',
      sourceCode: 'Källsymbol',
      sourceMarket: 'Källmarknad (valfritt)',
      anyMarket: 'Alla marknader',
      targetCode: 'Målsymbol',
      targetMarket: 'Målmarknad (valfritt)',
      sameAsSource: 'Samma som källa',
      delistDate: 'Avnoteringsdatum',
      delistPrice: 'Sista handelskurs',
      note: 'Anteckning (valfritt)',
      add: 'Lägg till',
      emptyHint: 'Inga regler. Klicka på «Lägg till regel» för att konfigurera tickeralias eller avnoteringsstängningar.',
      noCustomRules: 'Inga anpassade regler. Klicka på «Lägg till regel» för att lägga till en.',
      builtIn: 'inbyggd',
      deleteRule: 'Ta bort den här regeln',
      delistAutoNote: 'Avnoteringsregler injicerar automatiskt en «sälj allt»-post vid beräkning av vinst/förlust. Dina ursprungliga data ändras inte.',
      delistLabel: 'avnoteringsstängning',
      autoLabel: 'auto'
    }
  },
  notice: {
...
const csCZ = {
  ...
  manager: {
    ...
    symbolOverrides: {
      title: 'Pravidla nahrazení symbolů',
      addRule: 'Přidat pravidlo',
      ruleType: 'Typ pravidla',
      typeAlias: 'Alias (přejmenování)',
      typeDelist: 'Vyřazení z burzy (nucené uzavření)',
      sourceCode: 'Zdrojový symbol',
      sourceMarket: 'Zdrojový trh (volitelné)',
      anyMarket: 'Jakýkoli trh',
      targetCode: 'Cílový symbol',
      targetMarket: 'Cílový trh (volitelné)',
      sameAsSource: 'Stejný jako zdroj',
      delistDate: 'Datum vyřazení z burzy',
      delistPrice: 'Poslední obchodní cena',
      note: 'Poznámka (volitelné)',
      add: 'Přidat',
      emptyHint: 'Žádná pravidla. Klikněte na «Přidat pravidlo» pro nastavení aliasů tickerů nebo uzavření při vyřazení z burzy.',
      noCustomRules: 'Žádná vlastní pravidla. Klikněte na «Přidat pravidlo» pro přidání.',
      builtIn: 'vestavěný',
      deleteRule: 'Smazat toto pravidlo',
      delistAutoNote: 'Pravidla vyřazení z burzy při výpočtu zisku/ztráty automaticky vkládají záznam «prodat vše». Vaše původní data nejsou změněna.',
      delistLabel: 'uzavření při vyřazení',
      autoLabel: 'auto'
    }
  },
  notice: {
...
const roRO = {
  ...
  manager: {
    ...
    symbolOverrides: {
      title: 'Reguli de înlocuire a simbolurilor',
      addRule: 'Adaugă regulă',
      ruleType: 'Tipul regulii',
      typeAlias: 'Alias (redenumire)',
      typeDelist: 'Delistare (închidere forțată)',
      sourceCode: 'Simbol sursă',
      sourceMarket: 'Piață sursă (opțional)',
      anyMarket: 'Orice piață',
      targetCode: 'Simbol destinație',
      targetMarket: 'Piață destinație (opțional)',
      sameAsSource: 'La fel ca sursa',
      delistDate: 'Data delistării',
      delistPrice: 'Ultimul preț tranzacționat',
      note: 'Notă (opțional)',
      add: 'Adaugă',
      emptyHint: 'Nicio regulă. Faceți clic pe «Adaugă regulă» pentru a configura aliasuri de ticker sau închideri la delistare.',
      noCustomRules: 'Nicio regulă personalizată. Faceți clic pe «Adaugă regulă» pentru a adăuga una.',
      builtIn: 'integrat',
      deleteRule: 'Șterge această regulă',
      delistAutoNote: 'Regulile de delistare inserează automat o înregistrare «vinde tot» la calcularea P&L. Datele dvs. originale nu sunt modificate.',
      delistLabel: 'închidere delistare',
      autoLabel: 'auto'
    }
  },
  notice: {
...
const huHU = {
  ...
  manager: {
    ...
    symbolOverrides: {
      title: 'Szimbólum-felülírási szabályok',
      addRule: 'Szabály hozzáadása',
      ruleType: 'Szabály típusa',
      typeAlias: 'Álnév (átnevezés)',
      typeDelist: 'Tőzsdei kivezetés (kényszerzárás)',
      sourceCode: 'Forrás szimbólum',
      sourceMarket: 'Forrás piac (nem kötelező)',
      anyMarket: 'Bármely piac',
      targetCode: 'Cél szimbólum',
      targetMarket: 'Cél piac (nem kötelező)',
      sameAsSource: 'Ugyanaz, mint a forrás',
      delistDate: 'Kivezetés dátuma',
      delistPrice: 'Utolsó kereskedési ár',
      note: 'Megjegyzés (nem kötelező)',
      add: 'Hozzáadás',
      emptyHint: 'Nincsenek szabályok. Kattintson a „Szabály hozzáadása" gombra ticker-álnevek vagy tőzsdei kivezetési zárások beállításához.',
      noCustomRules: 'Nincsenek egyéni szabályok. Kattintson a „Szabály hozzáadása" gombra egy hozzáadásához.',
      builtIn: 'beépített',
      deleteRule: 'Szabály törlése',
      delistAutoNote: 'A tőzsdei kivezetési szabályok automatikusan „mindent elad" bejegyzést szúrnak be a nyereség/veszteség kiszámításakor. Az eredeti adatai nem módosulnak.',
      delistLabel: 'kivezetési zárás',
      autoLabel: 'automatikus'
    }
  },
  notice: {
...
const daDK = {
  ...
  manager: {
    ...
    symbolOverrides: {
      title: 'Regler for symbolerstatning',
      addRule: 'Tilføj regel',
      ruleType: 'Regeltype',
      typeAlias: 'Alias (omdøb)',
      typeDelist: 'Afnotering (tvungen lukning)',
      sourceCode: 'Kildesymbol',
      sourceMarket: 'Kildemarked (valgfrit)',
      anyMarket: 'Alle markeder',
      targetCode: 'Målsymbol',
      targetMarket: 'Målmarked (valgfrit)',
      sameAsSource: 'Samme som kilde',
      delistDate: 'Afnoteringsdato',
      delistPrice: 'Sidste handelskurs',
      note: 'Note (valgfrit)',
      add: 'Tilføj',
      emptyHint: 'Ingen regler. Klik på «Tilføj regel» for at opsætte ticker-aliasser eller afnoteringslukninger.',
      noCustomRules: 'Ingen brugerdefinerede regler. Klik på «Tilføj regel» for at tilføje en.',
      builtIn: 'indbygget',
      deleteRule: 'Slet denne regel',
      delistAutoNote: 'Afnoteringsregler indsætter automatisk en «sælg alt»-post ved beregning af afkast. Dine originale data ændres ikke.',
      delistLabel: 'afnoteringslukning',
      autoLabel: 'auto'
    }
  },
  notice: {
...
const elGR = {
  ...
  manager: {
    ...
    symbolOverrides: {
      title: 'Κανόνες αντικατάστασης συμβόλων',
      addRule: 'Προσθήκη κανόνα',
      ruleType: 'Τύπος κανόνα',
      typeAlias: 'Ψευδώνυμο (μετονομασία)',
      typeDelist: 'Διαγραφή από χρηματιστήριο (αναγκαστικό κλείσιμο)',
      sourceCode: 'Σύμβολο πηγής',
      sourceMarket: 'Αγορά πηγής (προαιρετικό)',
      anyMarket: 'Οποιαδήποτε αγορά',
      targetCode: 'Σύμβολο στόχου',
      targetMarket: 'Αγορά στόχου (προαιρετικό)',
      sameAsSource: 'Ίδιο με την πηγή',
      delistDate: 'Ημερομηνία διαγραφής',
      delistPrice: 'Τελευταία τιμή συναλλαγής',
      note: 'Σημείωση (προαιρετικό)',
      add: 'Προσθήκη',
      emptyHint: 'Δεν υπάρχουν κανόνες. Κάντε κλικ στο «Προσθήκη κανόνα» για ρύθμιση ψευδωνύμων ticker ή κλεισιμάτων διαγραφής.',
      noCustomRules: 'Δεν υπάρχουν προσαρμοσμένοι κανόνες. Κάντε κλικ στο «Προσθήκη κανόνα» για προσθήκη.',
      builtIn: 'ενσωματωμένο',
      deleteRule: 'Διαγραφή αυτού του κανόνα',
      delistAutoNote: 'Οι κανόνες διαγραφής εισάγουν αυτόματα μια εγγραφή «πώληση όλων» κατά τον υπολογισμό P&L. Τα αρχικά δεδομένα σας δεν τροποποιούνται.',
      delistLabel: 'κλείσιμο διαγραφής',
      autoLabel: 'αυτόματο'
    }
  },
  notice: {
...
const localeTranslations = applyLocaleDeepVoiceRefinements(applyLocaleVoiceRefinements(applyImportTranslationCoverage({
  'zh-TW': zhTW,
